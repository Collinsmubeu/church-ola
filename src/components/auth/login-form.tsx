  ...
  return (
    <div className="space-y-5">
      <Button
        type="button"
        variant="outline"
        className="w-full h-11 rounded-lg border-gray-200 hover:bg-gray-50 hover:border-gray-300 transition-all"
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              placeholder="••••••••"
              className="pl-10 pr-10 h-11 rounded-lg border-gray-200 focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500"
              {...register("password")}
            />
            <button
              type="button"
